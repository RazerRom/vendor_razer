#
# RazerRom Audio Files
#

ALARM_PATH := vendor/razer/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/razer/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/razer/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/razer/prebuilt/common/media/audio/ui
